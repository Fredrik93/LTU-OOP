...
/**
 * Inlämningsuppgift 4 Syfte: Sparkonto för en kund
 *
...
public class SavingsAccount extends Account
{
    ...
    @Override
    public void createTransaction(LocalDateTime date, int transactionAmnt, BigDecimal currentAmount, int accountNumber)
    {
