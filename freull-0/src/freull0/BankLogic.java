...
{
    private final List<freull0.Customer> customers = new ArrayList<>();
    ...
    {
        freull0.Customer customer = findCustomer(pNo);
     ...
     */
    private freull0.Customer findCustomer(String pNo)
    {
        for(freull0.Customer customer : customers)
        {
    ...
    {
        freull0.Customer customer = findCustomer(pNo);
        freull0.Account account = findAccount(customer, accountNumber);
        if(account != null)
        {
     ...
     */
    private freull0.Account findAccount(freull0.Customer customer, int accountNumber)
    {
        if(customer != null)
        {
            for(int i = 0; i < customer.getAccounts().size(); i++)
    ...
    public List<String> getAllCustomers()
    {
        ...
        for(freull0.Customer c : customers)
        {
    ...
    public List<String> getCustomer(String pNo)
    {
        ...
        freull0.Customer c = findCustomer(pNo);
        ...
        {
            for(freull0.Account item : c.getAccounts())
            {
    ...
    public boolean createCustomer(String name, String surname, String pNo)
    {
        ...
        freull0.Customer newCustomer = new freull0.Customer(name, surname, pNo);
    ...
    public int createSavingsAccount(String pNo)
    {
        for(freull0.Customer c : customers)
        {
            if(c.getpNo().equals(pNo))
            {
                freull0.Account newAccount = new freull0.Account(new BigDecimal(0), new BigDecimal("2.4"),
