...
/**
 * D0018D, Lab 1: Testar att klasserna Account, Customer and freull0.BankLogic fungerar som de ska. Notera att klassen
 * kan uppdateras under kursens gång.
 *
 * Denna klass placeras i default package direkt i src-mappen Ändra paketets namn <qwerty0> i importen ovan, så den
 * matchar ditt pakets namn <användarid>
 *
 ...
 *
 * Om du får FAIL men allt ser exakt rätt ut, kan det vara ett whitespace-tecken som inte blir rätt. Troligtvis blir det
 * rätt hos mig ändå så det brukar vara okej ändå att lämna in.
 *
...
public class TestBank
{
    ...
    public void test()
    {
        ...
        testingGetCustomer("8505221898",
                "[8505221898 Kalle Karlsson, 1001 0,00 kr Sparkonto 2,4 %, 1003 0,00 kr Sparkonto 2,4 %]");
        ...
        testingGetCustomer("8505221898",
                "[8505221898 Kalle Karlsson, 1001 1 000,00 kr Sparkonto 2,4 %, 1003 0,00 kr Sparkonto 2,4 %]");
        ...
        testingGetCustomer("7505121231",
                "[7505121231 Lotta Larsson, 1004 0,00 kr Sparkonto 2,4 %, 1005 700,00 kr Sparkonto 2,4 %]");
     ...
     * @param facit
     *         - the facit that we compares with
     */
