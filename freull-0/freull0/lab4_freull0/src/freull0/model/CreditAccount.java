...
/**
 * Inlämningsuppgift4 Syfte: innehåller logiken för Kreditkonto
 *
...
public class CreditAccount extends Account
{
    ...
    @Override
    public void createTransaction(LocalDateTime date, int transactionAmount, BigDecimal currentAmount,
            int accountNumber)
    {
