...
/**
 * D0018D, Lab 2: Testar att klasserna Account, Customer and BankLogic fungerar som de ska. Notera att klassen kan
 * uppdateras under kursens gång.
 *
 * Denna klass placeras i default package OBS! Ändra paketets namn <qwerty0> i importen ovan, så den matchar ditt pakets
 * namn <användarid>
 *
 * Testprogrammet kontrollerar att det som returneras från dina metoder är det som förväntas returneras. Detta betyder
 * att du måste justera strängarna så den är exakt så som specificeras i uppgiften.
 *
...
public class TestBank3
{
    ...
    public void test() throws FileNotFoundException, InterruptedException
    {
        ...
        testingGetCustomer("8505221898",
                "[8505221898 Kalle Karlsson, 1001 0,00 kr Kreditkonto 1,1 %, 1003 0,00 kr Sparkonto 2,4 %]");
        ...
        testingGetCustomer("8505221898",
                "[8505221898 Kalle Karlsson, 1001 -4 500,00 kr Kreditkonto 5 %, 1003 500,00 kr Sparkonto 2,4 %]");

        // #31 Get transactions
        personalNumber = "8505221898";
        accountNumber = 1001;
        testingGetTransactions(personalNumber, accountNumber,
                "[" + strDate1001_1 + " -500,00 kr Saldo: -500,00 kr, " + strDate1001_2 + " -4 000,00 kr Saldo: -4 500,00 kr]");
        ...
        testingGetCustomer("7505121231",
                "[7505121231 Lotta Larsson, 1004 0,00 kr Sparkonto 2,4 %, 1005 0,00 kr Sparkonto 2,4 %]");
        ...
        // #52 Get transactions
        testingGetTransactions(personalNumber, 1005,
                "[" + strDate1005_1 + " 1 000,00 kr Saldo: 1 000,00 kr, " + strDate1005_2 + " -100,00 kr Saldo: 900,00 kr, " + strDate1005_3 + " -102,00 kr Saldo: 798,00 kr]");

        // #53 Get information about the customer including accounts
        testingGetCustomer("7505121231",
                "[7505121231 Lotta Larsson, 1004 500,00 kr Sparkonto 2,4 %, 1005 798,00 kr Sparkonto 2,4 %]");
        ...
        testingDeleteCustomer("7505121231",
                "[7505121231 Lotta Larsson, 1004 500,00 kr Sparkonto 12,00 kr, 1005 798,00 kr Sparkonto 19,15 kr]");
        ...
        testingGetCustomer("6911258876",
                "[6911258876 Pelle Persson, 1002 0,00 kr Kreditkonto 1,1 %, 1007 0,00 kr Sparkonto 2,4 %]");
        ...
        testingGetCustomer("6911258876",
                "[6911258876 Pelle Persson, 1002 -1 000,00 kr Kreditkonto 5 %, 1007 0,00 kr Sparkonto 2,4 %]");

        // #73 Deletes the customer
        testingDeleteCustomer("6911258876",
                "[6911258876 Pelle Persson, 1002 -1 000,00 kr Kreditkonto -50,00 kr, 1007 0,00 kr Sparkonto 0,00 kr]");
     ...
     *
     * @param String
     *         facit - the facit that we compares with
     */
    private void testingGetAllCustomers(String facit)
    {
        ...
        // Calls the function
        List<String> result = bank.getAllCustomersAsStrings();
     ...
     *
     * @param pNo
     *         - Personal number of customer that owns the account
     * @param accountId
     *         - Id of the account that will be printed
     * @param String
     *         facit - the facit that we compares with
     */
     ...
     * @param pNo
     *         - Personal number of customer
     * @param boolean
     *         facit - true if customer should be created otherwice false
     */
    private void testingCreateCustomer(String name, String surname, String pNo, boolean facit)
    {
        ...
        {
            System.out.println(
                    "Test " + testCounter++ + ": FAIL - createCustomer(" + name + ", " + surname + ", " + pNo + ")");
        }
    }
     ...
     *         - The new surname
     * @param pNo
     *         - Personal number of customer that is getting a new name
     * @param facit
     *         - true if customer name should change otherwise false
     */
    private void testingChangeName(String name, String surname, String pNo, boolean facit)
    {
        ...
        {
            System.out.println(
                    "Test " + testCounter++ + ": FAIL - testingChangeName(" + name + ", " + surname + ", " + pNo + ")");
        }
    }
     ...
     *
     * @param pNo
     *         - Personal number of customer that is getting a new account
     * @param facit
     *         - "-1" if a account is not created otherwise a accountnumber
     */
     ...
     *
     * @param pNo
     *         - The personal number of the customer that owns the account
     * @param accountId
     *         -  The id of the account
     * @param amount
     *         - The amount
     * @param facit
     *         - true if the amount is deposit false otherwise
     */
    private void testingDeposit(String pNo, int accountId, int amount, boolean facit)
    {
        ...
        {
            System.out.println(
                    "Test " + testCounter++ + ": FAIL - deposit(" + pNo + ", " + accountId + ", " + amount + ")");
        }
    }
     ...
     *         - The amount
     * @param facit
     *         - true if the amount is withdraw false otherwise
     */
    private void testingWithdraw(String pNo, int accountId, int amount, boolean facit)
    {
        ...
        {
            System.out.println(
                    "Test " + testCounter++ + ": FAIL - withdraw(" + pNo + ", " + accountId + ", " + amount + ")");
        }
    }
     ...
     *         - The personal number of the customer that owns the account
     * @param accountId
     *         - The id of the account that is to be closed
     * @param String
     *         facit - the facit that we compares with
     */
     ...
     *
     * @param pNo
     *         - The personal number of the customer that is to be deleted
     * @param String
     *         facit - the facit that we compares with
     */
    ...
    {
        TestBank3 bankMenu = new TestBank3();
        bankMenu.test();
    }
}
